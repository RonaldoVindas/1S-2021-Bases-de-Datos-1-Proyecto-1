...
public class LogIn_Window extends javax.swing.JFrame {
    ...
    try{
       ...
       String encrypted_password = DBConnection.ConnectDB.EncryptPassword(password);
       ...
       if (email.equals(personEmail)){
           ...
           if (encrypted_password.equals(personPassword)){
               ...
               if (personTypePerson == 1){
                   Admin_Menu result = new Admin_Menu();
                   dispose();
                   result.setVisible(true);
               }
               else if (personTypePerson == 2){
