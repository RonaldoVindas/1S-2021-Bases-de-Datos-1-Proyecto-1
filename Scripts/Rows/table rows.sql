...
insert into Publisher(publisher_name) values('T�?h�?');
...
insert into  Person(first_name,last_name, email, password, phone_number,birth_day, persontype_id) values('Dennis','�?ngulo','Dernudo@outlook.com','ande8','98746526',DATE '1993-05-17',2);
